...
flangeThicknessesTop =      [0.004,   0.0142, 0.0132, 0.0112, 0.0105,   0.010,  0.009,  0.0065, 0.0049, 0.003,  0.003,  0.003] # m
flangeThicknessesBottom =   [0.004,   0.0142, 0.0132, 0.0112, 0.0104,   0.010,  0.009,  0.0065, 0.0049, 0.003,  0.003,  0.003] # m
stringersTop =              [5,      30,     26,     26,     18,       16,     11,     7,      3,      1,      1,      0] # m
stringersBottom =           [5,      20,     16,     16,     14,       12,     6,      6,      2,      1,      0,      0] # m
